...
(function ($, Drupal, window) {
     ...
     * First error focus.
     */
    Drupal.behaviors.firstErrorFocus = {
        attach: function (context) {
            $(":input.error:first").focus();

            if($('.js-form-item-field-tf-email-0-value').hasClass('error has-error')){
                $('.js-form-item-field-phone-0-value').addClass('error has-error');
            }
        }
    };
